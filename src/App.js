      ...
      <>
        <Router>
          ...
          <div className="container">
            ...
            <Route exact path="/science" element={<News key="science" pageSize={this.size} country="us" category="science" />} />
            <Route exact path="/sports" element={<News key="sports" pageSize={this.size} country="us" category="sports" />} />
            <Route exact path="/technology" element={<News key="technology" pageSize={this.size} country="us" category="technology" />} />
          </Routes>
          </div>
        </Router>
      </>
